        ...
        <FormPopover sideOffset={10} side='right'>
          ...
          >
            ...
            <Hint
              ...
              description={
                isPro
                  ? 'Your premium workspace includes unlimited boards. Enjoy unrestricted access to all your projects'
                  : 'Free workspaces are limited to 5 active boards. Upgrade to unlock unlimited boards and enhance your productivity'
              }
            >
